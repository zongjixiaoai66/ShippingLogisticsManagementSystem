        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '物流标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.wuliuName" placeholder="物流标题" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '物流状态' : ''">
                        <el-select v-model="searchForm.wuliuTypes" placeholder="请选择物流状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in wuliuTypesSelectSearch"
                               v-bind:key="index"
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '仓库' : ''">
                        <el-select v-model="searchForm.cangkuTypes" placeholder="请选择仓库">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/chuanyunwuliu/upload/wuliuMuBan.xls"
                        >批量导入物流记录数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuliu','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '申请状态': 'huoyunYesnoTypes',
                     '审核意见': 'huoyunYesnoText',
                     '审核时间': 'huoyunShenheTime',
                     '货运金额': 'huoyunJine',
                     '是否支付': 'huoyunZhifuTypes',
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.wuliuName!= '' && this.searchForm.wuliuName!= undefined) {
                    params['wuliuName'] = '%' + this.searchForm.wuliuName + '%'
                }
         
                if (this.searchForm.wuliuTypes!= '' && this.searchForm.wuliuTypes!= undefined) {
                    params['wuliuTypes'] = this.searchForm.wuliuTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=wuliu_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.wuliuTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
